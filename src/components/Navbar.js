...
import logo from '../assets/MOROCK_logo_cropped.png';
const Navbar = () => {
            ...
            <div className="row">
                ...
                <div className="header__middle__menus">
                    ...
                    <ul className={boxClass.join(' ')}>
                        ...
                        <li onMouseEnter={toggleSubmenu} className="menu-item sub__menus__arrows" > <NavLink onClick={toggleClass} activeClassName='is-active' to={`/products`}> Products <FiChevronDown /> </NavLink>
                            <ul className={boxClassSubMenu.join(' ')} > 
                                <li> <NavLink onClick={toggleClass} activeClassName='is-active'  to={`/products/rock-drilling`}> Rock Drilling </NavLink> </li>
                                <li><NavLink onClick={toggleClass} activeClassName='is-active' to={`/products/diamond-drilling`}> Diamond Drilling </NavLink> </li>
                            </ul>
                        </li>
